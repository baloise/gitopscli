...
class DeletePRPreviewCommandTest(unittest.TestCase):
    ...
    def test_delete_existing_happy_flow(self):
        ...
        assert self.mock_manager.method_calls == [
            ...
            call.logging.info("Preview folder name: %s", "APP-cfc08380-preview"),
            call.git_util.get_full_file_path("APP-cfc08380-preview"),
            call.os.path.exists("/tmp/created-tmp-dir/APP-cfc08380-preview"),
            call.shutil.rmtree("/tmp/created-tmp-dir/APP-cfc08380-preview", ignore_errors=True),
            call.git_util.commit("Delete preview environment for 'APP' and preview id 'mybranch'."),
    ...
    def test_delete_missing_happy_flow(self):
        ...
        assert self.mock_manager.method_calls == [
            ...
            call.os.path.exists("/tmp/created-tmp-dir/APP-cfc08380-preview"),
            call.logging.info(
                "No preview environment for '%s' and preview id '%s'. Nothing to do..", "APP", "mybranch"
            ),
        ]
    ...
    def test_delete_missing_but_expected_error(self):
        ...
        self.assertEqual(str(ex.value), "There was no preview with name: APP-cfc08380-preview")
