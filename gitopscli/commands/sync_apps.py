...
def __sync_apps(team_config_git_repo: GitRepo, root_config_git_repo: GitRepo, git_user: str, git_email: str) -> None:
    ...
    apps_config_file, apps_config_file_name, current_repo_apps, apps_from_other_repos, found_apps_path = __find_apps_config_from_repo(
...
def __find_apps_config_from_repo(
    ...
    return found_app_config_file, found_app_config_file_name, found_app_config_apps, apps_from_other_repos, found_apps_path
