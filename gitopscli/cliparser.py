...
def create_cli(args):
    ...
    __add_create_preview_common_command_parser(subparsers)
...
def __add_create_preview_common_command_parser(subparsers):
...
def __add_create_pr_preview_command_parser(subparsers):
    ...
    __add_branch_pr_parser_args(add_create_pr_preview_p)
